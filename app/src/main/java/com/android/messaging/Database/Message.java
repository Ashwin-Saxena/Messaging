...
Button send,id_sub;
public String myusername,otherusername,username,common_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String uidd = t1.getText().toString();
...
//                        Toast.makeText(Message.this,uidd,Toast.LENGTH_SHORT).show();
                        otherusername=dataSnapshot.child(t1.getText().toString()).getValue().toString();
                        head.setVisibility(View.VISIBLE);
                        head.setText(otherusername);
                       common_id=generate_com_id(mAuth.getUid(),uidd);
